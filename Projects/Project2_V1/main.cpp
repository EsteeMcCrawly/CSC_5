...
int main(int argc, char** argv) {
    ...
    menuSiz=3;                  //Number of options in the menu
    ...
    while(menu!=menuSiz){
        ...
        cout<<"Enter 3 to take your winnings and leave"<<endl;
        cin>>menu;
        cout<<endl;
        ...
        switch(menu){
            ...
            case 3:{
                ...
                resltFi(out,table,ROWS,numWin,numLoss,totlRol,mostRol,totlTim,totlGam);
                break;
            }
...
void resltFi(ofstream &out,int table[][COLS],int ROWS,int numWin,int numLoss,int totlRol,int mostRol,int totlTim,int totlGam){
