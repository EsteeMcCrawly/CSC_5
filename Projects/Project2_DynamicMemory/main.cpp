...
bool plyCrap(int[][COLS],vector<int>&,int[],bool&,int&,int&,int&,int);//Main game of craps
...
int main(int argc, char** argv) {
    ...
    int table[ROWS][COLS]={},//Initializing the win array
        ...
        *simWin=new int[ROWS],   //Allocate Memory
        *simLoss=new int[ROWS], //Allocate Memory
...
void results(int table[][COLS],int ROWS,int numWin,int numLoss,int mostRol,int totlRol,int totlTim,int totlGam){
    //Create 2D array table that outputs which rolls resulted in win/loss
